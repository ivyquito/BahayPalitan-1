				...
				<div class="container-page">				
					<div class="col-md-offset-2 col-lg-8">
                        ...
                        <div class="panel-body" style="min-height:300px">
                            <form action="<?php echo base_url(); ?>user_page_travelplan/add" class="form-signin" method="post" accept-charset="utf-8">
                            <fieldset>
                           ...
                           <div class="form-group col-lg-6">
                            ...
                            <div class=" col-lg-6 col-md-offset-5">
                                <br>
                                <input type="submit" name="travel_plan" class="btn btn-primary" id="" value="Save">
                            </div>
                            </fieldset>
                            </form>
                        </div>
