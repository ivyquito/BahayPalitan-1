<?php
    ...
    $mdata = array('toID'=>$nav_var->subID,'mstatus'=>1);
    $mout = $this->common->getall('messages',$mdata);
    if(count($mout)>0){
      $msg ='('.count($mout).')';
    }else{
      $msg='';
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                      <a class="page-scroll" href="<?php echo base_url() ?>user_page_inbox"><span class="fa fa-envelope"></span> Inbox <?php echo $msg; ?><span style="color:#f05f40"></span></a>
                    </li>
